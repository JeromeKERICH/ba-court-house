...
const ServiceCTA = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 to-orange-100 py-16 px-4 sm:px-6 lg:px-8 text-center">
      {/* Content */}
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Whether you're scaling up, building from scratch, or simply need expert advice. We're here to walk the journey with you.
        </p>

        <button
          onClick={() => setShowModal(true)}
          className="bg-orange-600 text-white px-10 py-4 rounded-lg text-xl font-semibold hover:bg-blue-700 transition duration-300"
        >
