            ...
            >
              ...
              >
                <div className="flex items-start mb-5">
                  <div className="p-3 bg-blue-100 rounded-xl mr-5">
              ...
              >
                <div className="flex items-start mb-5">
                  <div className="p-3 bg-orange-100 rounded-xl mr-5">
          ...
          >
            ...
            >
              ...
              <div 
                ...
                style={{ backgroundImage: "url('/assets/r2.jpg')" }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/70 to-blue-400/70"></div>
              </div>
            </motion.div>
          </motion.div>
              </motion.div>
