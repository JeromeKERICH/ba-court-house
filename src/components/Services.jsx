    ...
    <section className="py-16 sm:py-20 lg:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="p-6">
                ...
                <div className={`inline-flex items-center text-orange-600 font-medium group-hover:underline`}>
                  Learn more
        ...
        <div className="mt-16 text-center">
          <Link
            to="/services"
            className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-orange-500 hover:bg-orange-600 transition-colors duration-300"
          >
            View All Services
